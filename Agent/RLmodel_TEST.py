...
agent = dict(
        ...
        # dict(type='dense',size=75, activation='tanh'),
        # dict(type='dense',size=50, activation='tanh'),
        # dict(type='dense',size=25, activation='tanh')
        ...
        summarizer = dict(directory= 'test/summaries_qq'),
        saver=dict(directory='test/testmodel_saverqq', frequency=10, max_checkpoints=1000),
        memory = 60000
    )
...
# agent = Agent.load(directory='test/testmodel_saverqq', format='checkpoint')
